...
localforage.getItem(solutionquery).then(function(result) {
solutionquestion.innerText=result.solutionquestion;
		solutionstep1.innerText = result.solutionstep1;
		solutionstep2.innerText = result.solutionstep2;
		solutionstep3.innerText = result.solutionstep3;
		solutionstep4.innerText = result.solutionstep4;
		solutionstep5.innerText = result.solutionstep5;
}).catch(function(err) {
...
localforage.setItem(question,{'question':questiontext,'answerA':answerA,'answerB':answerB,'answerC':answerC,'answerD':answerD,'correctAnswer':correctAnswer}).then(function (value) {
...
localforage.setItem(solution,{'solutionquestion':solutionquestion,'solutionstep1':solutionstep1,'solutionstep2':solutionstep2,'solutionstep3':solutionstep3,'solutionstep4':solutionstep4,'solutionstep5':solutionstep5}).then(function (value) {
...
localforage.iterate(function(value, key, iterationNumber) {
   ...
   progressbar.value += percentage;
    jsonstore.push(objstore.key);
}).then(function() {
   progressdiv.style.display="none";
   alert("saving to cloud" + ((jsonstore)[1]).question);
   loadDoc(jsonstore);
}).catch(function(err) {
    // This code runs if there were any errors
    console.log(err);
